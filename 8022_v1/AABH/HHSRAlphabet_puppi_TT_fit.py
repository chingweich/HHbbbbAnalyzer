...
preselection    =       "&dijetmass_softdrop_corr>750"
...
############# DATASETS: #################
QCD1 = DIST("DATA1", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD500.root","mynewTree",str(Options.lumi)+"*31630./16563300.")
QCD2 = DIST("DATA2", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD700.root","mynewTree",str(Options.lumi)+"*6802./10206600.")
QCD3 = DIST("DATA3", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD1000.root","mynewTree",str(Options.lumi)+"*1206./3407530.")
QCD4 = DIST("DATA4", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD1500.root","mynewTree",str(Options.lumi)+"*120.4/3161430.")
QCD5 = DIST("DATA5", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD2000.root","mynewTree",str(Options.lumi)+"*25.25/3234700.")
DATA = DIST("DATA", "/afs/cern.ch/work/c/chchen/public/JetHT.root","mynewTree","1.")
...
sigpath = "/afs/cern.ch/work/c/chchen/public/Summer2016Garviton/"
...
if Options.workspace == "alphabet":
	...
	for m in mass:
		...
		quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_antitag, variable2, TightAT, "puWeights*(1.-SFTight)/1.")
