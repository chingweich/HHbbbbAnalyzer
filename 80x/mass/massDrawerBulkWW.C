...
TCanvas* c1;
void massDrawerBulkWW(){
	setNCUStyle();
	c1 = new TCanvas("c1","",1360,768);
	
	TFile* tf1[2];
	tf1[0]=TFile::Open("output/BulkWW1000.root");
	tf1[1]=TFile::Open("output/BulkWW4000.root");
	...
	th1[6]->Draw("same,c");
	leg->Draw("same");
	c1->Print("output/bulkWW_leading_wo.pdf");
	...
	th1[6]->Draw("same,c");
	leg->Draw("same");
	c1->Print("output/bulkWW_L+S_wo.pdf");
	leg->Clear();
	...
	th1[7]->Draw("same,c");
	leg->Draw("same");
	c1->Print("output/bulkWW_leading_with.pdf");
	...
	th1[7]->Draw("same,c");
	leg->Draw("same");
	c1->Print("output/bulkWW_L+S_with.pdf");
	...
	leg3->Clear();
	leg3->AddEntry(tg1[0],"1TeV,PRmass");
	leg3->AddEntry(tg1[2],"1TeV,PuppiSDmass");
	leg3->AddEntry(tg1[8],"1TeV,PRmass+tau21");
	leg3->AddEntry(tg1[9],"1TeV,PuppiSDmass+puppitau21");
	...
	tg1[9]->Draw("PL,same");
	leg3->Draw("same");
	c1->Print("output/bulkWW1000_PV_tau21_wo.pdf");
	
	leg3->Clear();
	leg3->AddEntry(tg1[1],"1TeV,PRmassL2L3Corr");
	leg3->AddEntry(tg1[3],"1TeV,PuppiSDmassL2L3Corr");
	leg3->AddEntry(tg1[10],"1TeV,PRmassL2L3Corr+tau21");
	leg3->AddEntry(tg1[11],"1TeV,PuppiSDmassL2L3Corr+puppitau21");
	...
	tg1[11]->Draw("PL,same");
	leg3->Draw("same");
	c1->Print("output/bulkWW1000_PV_tau21_with.pdf");
