...
void HHbbbbAnalyzerBaseC(int wM, string st,string st2,double Xsec,bool isSignal=0){
...
void HHbbbbAnalyzer(int a){
	...
	string  masspointN[30]={"B1000","B1200","B1400","B1600","B1800","B2000","B2500","B3000","B3500","B4000","B4500",
	...
	//th1[a]=HHbbbbAnalyzerBaseHPHP(aa[a],st1[a],masspointN[a],Xsec[a],eff1,eff2,eff3,eff4,eff5,sig);
	HHbbbbAnalyzerBaseC(aa[a],st1[a],masspointN[a],Xsec[a],sig);
	//dataPrinter(aa[a],st1[a],masspointN[a],Xsec[a],sig);
