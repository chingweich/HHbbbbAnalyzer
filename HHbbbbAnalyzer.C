...
void HHbbbbAnalyzer(int a){
	...
	//if(!(a==22||a==23||a==24||a==25||a==100))HHbbbbAnalyzerBaseC(aa0[a],aa[a],st1[a],fileName[a],Xsec[a],sigName);
	if(!(a==100))HHbbbbAnalyzerBaseC(aa0[a],aa[a],st1[a],fileName[a],Xsec[a],sigName);
