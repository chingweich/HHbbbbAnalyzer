...
/*
TH1D* HHbbbbAnalyzerBaseHPHP(int wM, string st,string st2,double Xsec,double & db1,double & db2,double & db3,double & db4,double & db5,bool isSignal=0){
	...
	TH1D* cutflow=new TH1D("cutflow","",11,0,11);
