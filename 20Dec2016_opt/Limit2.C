...
void Limit2(){
	...
	TLegend *leg = new TLegend(0.65, 0.63, 0.96, 0.88);
  ...
  string categoryName[7]={"0a","0c","1a","1c","2a","2b","2d"};
	string files[3]={"TheaCorr/105_135.root","HCorr/105_135.root","HCorr/110_145.root"};
	string legneds[3]={"TheaCorr/105_135","HCorr/105_135","HCorr/110_145"};
	
	for(int h=0;h<3;h++){
		TFile* tf1=TFile::Open(Form("%s",files[h].data()));
		...
		tg1->SetTitle("");
			 ...
			 leg->AddEntry(tg1,Form("%s",legneds[h].data()));
