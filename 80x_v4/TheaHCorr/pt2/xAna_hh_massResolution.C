...
void xAna_hh_massResolution(int pt_down=60,int pt_up=0){
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B1000.root","B1000.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B1200.root","B1200.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B1400.root","B1400.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B1600.root","B1600.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B1800.root","B1800.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B2000.root","B2000.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B2500.root","B2500.root",pt_up,pt_down);
	xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B3000.root","B3000.root",pt_up,pt_down);
	//xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B4000.root","B4000.root",pt_up,pt_down);
	//xAna_hh_massResolutionBase("/data7/chchen/AK8PuppijetGenSDmass/B/B4500.root","B4500.root",pt_up,pt_down);
