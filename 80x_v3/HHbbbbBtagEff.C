...
void HHbbbbBtagEff(int a){
	...
	string dataPathC="/data7/chchen/80x_dsv/JetHT_runB/NCUGlobalTuples_";
	string dataPathD="/data7/chchen/80x_dsv/JetHT_runB/NCUGlobalTuples_";
	//cout<<"a"<<endl;
	//testBtag();
	if(a==21){
		for(int j=0;j<11;j++){
		...
		HH4bBtagEffBase_80(1,500,dataPathB,"data1");	
	}
	else if(a==31){
		HH4bBtagEffBase_80(500,1048,dataPathB,"data2");	
	}
	else if(a==32){
		HH4bBtagEffBase_80(1,348,dataPathC,"data3");	
	}
	else if(a==33){
		HH4bBtagEffBase_80(1,584,dataPathD,"data4");	
	}
	else if (a>21){
