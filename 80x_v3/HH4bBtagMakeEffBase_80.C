...
void HH4bBtagMakeEffBase_80(int wMs,int wM, string st,string st2,string option=""){	
	...
	double xbins[5]={30,140,180,240,3000};
	double xbins_l[11]={20,100,200,300,400,500,600,700,800,900,3000};
	
	TH2D* th1[6];
	th1[0]=new TH2D("effD_b","effD_b",4,xbins,30,-3,3);
	th1[1]=new TH2D("effN_b","effN_b",4,xbins,30,-3,3);
	th1[2]=new TH2D("effD_c","effD_c",4,xbins,30,-3,3);
	th1[3]=new TH2D("effN_c","effN_c",4,xbins,30,-3,3);
	th1[4]=new TH2D("effD_l","effD_l",4,xbins,30,-3,3);
	th1[5]=new TH2D("effN_l","effN_l",4,xbins,30,-3,3);
	
	TH1D* th2[6];
	th2[0]=new TH1D("effD_b_1d","effD_b_1d",4,xbins);
	th2[1]=new TH1D("effN_b_1d","effN_b_1d",4,xbins);
	th2[2]=new TH1D("effD_c_1d","effD_c_1d",4,xbins);
	th2[3]=new TH1D("effN_c_1d","effN_c_1d",4,xbins);
	th2[4]=new TH1D("effD_l_1d","effD_l_1d",10,xbins_l);
	th2[5]=new TH1D("effN_l_1d","effN_l_1d",10,xbins_l);
