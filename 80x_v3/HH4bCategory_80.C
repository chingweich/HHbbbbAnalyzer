...
void HH4bCategory_80(int a){
	...
	if(a==21)for(int j=0;j<11;j++)HH4bCategoryBase_80(1,2,st1[j],fileName[j],"");
	else if(a==30)HH4bCategoryBase_80(1,500,dataPathB,"data1");	
	else if(a==31)HH4bCategoryBase_80(500,1048,dataPathB,"data2");	
	else if(a==32)HH4bCategoryBase_80(1,348,dataPathC,"data3");	
	else if(a==33)HH4bCategoryBase_80(1,584,dataPathD,"data4");	
